...
// 특정 이벤트가 발생했을 때 어떤 이벤트가 발생했는지를 나타내는 문자열 값을 전달받음

// () => () : 단순히 하나의 '표현식'으로 바로 반환할 때
// () => {} : 여러 줄 '코드'할 때 명시적으로 'return을 표시'할 때
// const handleEvent = (name, which) => {   // 한 줄이라 ()사용해도 됨
//   console.log(name, which)
// }
// const Btn = ({ name }) => (   // {}이거 사용 시 return 사용
//   <Button variant='contained'
